...
class Producto extends GenericModel {
    ...
    public function __construct() {
        parent::__construct();
        $this->table = 'producto';
        $this->primaryKey = 'id_producto'; // Definimos la PK específica
    }
    ...
    public function crear($datos) {
        $query = "INSERT INTO " . $this->table . " 
                  (nombre, descripcion, precio_b2c, unidades_base_b2b, soles_base_b2b, 
                   unidad_minima_b2b, disponible_b2c, disponible_b2b, id_categoria) 
                  VALUES (:nombre, :descripcion, :precio_b2c, :unidades_base_b2b, :soles_base_b2b, 
                          :unidad_minima_b2b, :disponible_b2c, :disponible_b2b, :id_categoria)";
    ...
    public function actualizar($id, $datos) {
        $query = "UPDATE " . $this->table . " SET 
                  ...
                  unidad_minima_b2b = :unidad_minima_b2b, disponible_b2c = :disponible_b2c,
                  disponible_b2b = :disponible_b2b, id_categoria = :id_categoria

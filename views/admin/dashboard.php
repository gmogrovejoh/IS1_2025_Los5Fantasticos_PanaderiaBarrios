            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 mb-2">
                        <button class="btn btn-outline-primary w-100" onclick="location.href='<?= BASE_URL ?>admin/productos'">
                            <i class="fas fa-plus me-2"></i>Nuevo Producto
                        </button>
                    </div>
                    <div class="col-md-3 mb-2">
                        <button class="btn btn-outline-success w-100" onclick="location.href='<?= BASE_URL ?>admin/hojaProduccion'">
                            <i class="fas fa-calendar me-2"></i>Producción Hoy
                        </button>
                    </div>
                    <div class="col-md-3 mb-2">
                        <button class="btn btn-outline-info w-100" disabled>
